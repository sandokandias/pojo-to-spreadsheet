...
import com.github.sandokandias.pojo.to.spreadsheet.setter.AnnotationRowSetter;
import com.github.sandokandias.pojo.to.spreadsheet.setter.RowSetter;

public class AnnotationExcelPoiWriterTest extends AbstractExcelTest {

    protected RowSetter<Employee> rowSetter() {
        return new AnnotationRowSetter<Employee>();
    }
